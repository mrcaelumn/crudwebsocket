...
var CustomeErrorMedia = MediaType("application/vnd.crudwebsocket-error+json", func() {
...
var VersionMedia = MediaType("application/vnd.crudwebsocket-version+json", func() {
	ContentType("application/json")
